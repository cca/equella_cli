...
// this is shared between search and search2 endpoints
let searchHelpBase = `There are many filtering options.
    ...
    -i, --info TYPE: the amount or type data to return, choices are basic
        (default), all, attachment (a.k.a "file" or "files"), detail, drm,
        metadata (a.k.a. "md" or "xml"), and navigation (or "nav")
    ...
    -w, --where: XPath-like "where" query similar to Manage Resources, e.g.
        "/xml/metadata/title LIKE 'Beloved%'" (single-quote strings, must begin
        with /xml)`,
    docs = {
...
List of API endpoints:
    ...
    search2     new search endpoint with a few new options
...
It will also copy your password to your clipboard, if present.`,
    ...
    --mt, --mimeTypes: comma-separated list of MIME types to filter results by.
    --musts: comma-separated list of "search index key/value pairs", the
...
Available shortcuts:
    ...
    --length [INT]  number of taxonomies to return (default 10)
